...
namespace Hsbot.Core.MessageHandlers
{
    ...
    {
        private readonly Regex regex = new Regex("submit ?(.*) time", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        public override string[] TargetedChannels => new[] { "#headspring", "#hsbottesting", "#service-delivery" };
